...
class Trainer(object):
    ...
    def _train_it(self, it, batch, aug_transform=False):
        ...
        try:
            ...
            print('Runtime Error of loss.backward():', rt_err)
...
if __name__ == '__main__':
    ...
    if args.dataset in ['sapien', 'ogcdr', 'dynlab']:
        ...
        if args.dataset == 'dynlab':
            data_root = osp.join(data_root, 'mbs-shapewhole')
    ...
    dice_loss = DiceLoss()
    criterion = SupervisedMaskLoss(ce_loss, dice_loss, weights=args.loss['weights'])
